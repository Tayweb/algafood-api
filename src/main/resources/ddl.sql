...
create table foto_produto (content_type varchar(255), descricao varchar(255), nome_arquivo varchar(255), tamanho int8, produto_id int8 not null, primary key (produto_id));
create table grupo (id  bigserial not null, nome varchar(255), primary key (id));
create table grupo_permissao (grupo_id int8 not null, permissao_id int8 not null, primary key (grupo_id, permissao_id));
...
create table restaurante (id  bigserial not null, aberto boolean, ativo boolean, data_atualizacao timestamp(0), data_cadastro timestamp(0), endereco_bairro varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), endereco_logradouro varchar(255), endereco_numero varchar(255), nome_restaurante varchar(255) not null, taxa_frete numeric(19, 2) not null, cozinha_id int8 not null, endereco_cidade_id int8, primary key (id));
create table restaurante_forma_pagamento (restaurante_id int8 not null, forma_pagamento_id int8 not null, primary key (restaurante_id, forma_pagamento_id));
create table restaurante_usuario_responsavel (restaurante_id int8 not null, usuario_id int8 not null, primary key (restaurante_id, usuario_id));
create table usuario (id  bigserial not null, data_cadastro timestamp, email varchar(255), nome varchar(255), senha varchar(255), primary key (id));
create table usuario_grupo (usuario_id int8 not null, grupo_id int8 not null, primary key (usuario_id, grupo_id));
alter table cidade add constraint FKkworrwk40xj58kevvh3evi500 foreign key (estado_id) references estado;
alter table foto_produto add constraint FK4npv85rdbnvn7a6uc4o7jujy1 foreign key (produto_id) references produto;
...
alter table restaurante_usuario_responsavel add constraint FKp5xoqly0jvjow2qtvsc6m2a8x foreign key (usuario_id) references usuario;
alter table restaurante_usuario_responsavel add constraint FKb6qllil4954tf7wg9x5xj3weo foreign key (restaurante_id) references restaurante;
