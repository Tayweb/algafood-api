...
insert into cozinha (id, nome_cozinha) values (3,'Brasileira');
insert into cozinha (id, nome_cozinha) values (4, 'Argentina');

insert into restaurante (nome_restaurante, taxa_frete, cozinha_id, ativo) values ('New Hakata', 10, 1, true);
insert into restaurante (nome_restaurante, taxa_frete, cozinha_id, ativo) values ('Tuk tuk indiano', 29.90, 2, true);
insert into restaurante (nome_restaurante, taxa_frete, cozinha_id, ativo) values ('Comida Nordestina', 0, 3, true );
insert into restaurante (nome_restaurante, taxa_frete, cozinha_id, ativo) values ('Java Steakhouse', 12, 3, true );
insert into restaurante (nome_restaurante, taxa_frete, cozinha_id, ativo) values ('Lanchonete do Tio Sam', 11, 4, true );
insert into restaurante (nome_restaurante, taxa_frete, cozinha_id, ativo) values ('Bar da Maria', 6, 2, true);
